            ...
            Using conn_trans
                ...
                Try
                    ...
                    Else
                        ...
                        cmd1.Parameters.AddWithValue("@SUPL_CATEGORY", DropDownList4.Text)
                        cmd1.ExecuteReader()
                        cmd1.Dispose()
