<%@ Page Title="" Language="vb" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.Master" CodeBehind="OutsourceMatGARN.aspx.vb" Inherits="PLANT_DETAILS.OutsourceMatGARN" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row text-white mt-0" style="background: #296DA9">
        <div class="col text-center">
            <asp:Label ID="Label1" runat="server" Text="Outsourced Material GARN" Font-Bold="True" Font-Size="Larger"></asp:Label>
        </div>
    </div>
    ...
    <div class="row align-items-center mt-1">
        ...
        <div class="col-2 text-end">
            <asp:TextBox ID="TextBox2" CssClass="form-control" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                            ...
                            <div class="col">
                                    ...
                                    <div class="col-3 text-start" style="border-right: 3px; border-right-style: groove; border-right-color: #FF3399">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-4 text-start">
                                                <asp:Label ID="Label400" runat="server" Font-Bold="True" ForeColor="Blue" Text="GARN NO"></asp:Label>
                                            </div>
                                            <div class="col-8">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-4 text-start">
                                                <asp:Label ID="Label401" runat="server" Font-Bold="True" ForeColor="Blue" Text="CRR No"></asp:Label>
                                            </div>
                                            <div class="col-8">
                                        ...
                                        <div class="row align-items-center mt-0">
                                            <div class="col-4 text-start">
                                                <asp:Label ID="Label373" runat="server" Font-Bold="True" ForeColor="Blue" Text="MAT SLNo"></asp:Label>
                                            </div>
                                            <div class="col-8">
                                        ...
                                        <div class="row align-items-center mt-2">
                                            <div class="col-4 text-start">
                                                <asp:Label ID="Label397" runat="server" Font-Bold="True" ForeColor="Blue" Text="P.O. No"></asp:Label>
                                            </div>
                                            <div class="col-8">
                                    ...
                                    <div class="col-9">
                                        <div class="row align-items-center" style="background-color: #4686F0">
                                            <div class="col-6">
                                                <div class="row align-items-center">
                                                    <div class="col text-center">
                                                        <asp:Label ID="Label44" runat="server" Font-Bold="True" ForeColor="White" Text="As per Order"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6 text-center">
                                                <div class="row align-items-center">
                                                    <div class="col text-center">
                                                        <asp:Label ID="Label45" runat="server" Font-Bold="True" ForeColor="White" Text="As per Chalan"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4 text-start">
                                                        <asp:Label ID="Label404" runat="server" Font-Bold="True" ForeColor="Blue" Text="Unit Price"></asp:Label>
                                                    </div>
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label405" runat="server" Font-Bold="True" ForeColor="Blue" Text="Unit Price"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label406" runat="server" Font-Bold="True" ForeColor="Blue" Text="Discount"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label407" runat="server" Font-Bold="True" ForeColor="Blue" Text="Discount"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label408" runat="server" Font-Bold="True" ForeColor="Blue" Text="Packing"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label409" runat="server" Font-Bold="True" ForeColor="Blue" Text="Packing"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                        ...
                                        <div class="row ">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label410" runat="server" Font-Bold="True" ForeColor="Blue" Text="SGST"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label411" runat="server" Font-Bold="True" ForeColor="Blue" Text="SGST"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                        ...
                                        <div class="row ">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label412" runat="server" Font-Bold="True" ForeColor="Blue" Text="CGST"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label413" runat="server" Font-Bold="True" ForeColor="Blue" Text="CGST"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                        ...
                                        <div class="row ">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label416" runat="server" Font-Bold="True" ForeColor="Blue" Text="IGST"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label417" runat="server" Font-Bold="True" ForeColor="Blue" Text="IGST"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                        ...
                                        <div class="row ">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label9" runat="server" Font-Bold="True" ForeColor="Blue" Text="CESS"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label10" runat="server" Font-Bold="True" ForeColor="Blue" Text="CESS"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                        ...
                                        <div class="row ">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label11" runat="server" Font-Bold="True" ForeColor="Blue" Text="Analytical Charge P/U"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label12" runat="server" Font-Bold="True" ForeColor="Blue" Text="Analytical Charge P/U"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                        ...
                                        <div class="row ">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label414" runat="server" Font-Bold="True" ForeColor="Blue" Text="Freight"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label415" runat="server" Font-Bold="True" ForeColor="Blue" Text="Freight"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                        ...
                                        <div class="row ">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label387" runat="server" Font-Bold="True" ForeColor="Blue" Text="LD %"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label388" runat="server" Font-Bold="True" ForeColor="Blue" Text="LD (Rs.)"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-2 text-start">
                                                <asp:Label ID="Label419" runat="server" Font-Bold="True" ForeColor="Red" Visible="False"></asp:Label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label384" runat="server" Font-Bold="True" ForeColor="Blue" Text="Local Freight"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                            ...
                                            <div class="col-5 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label386" runat="server" Font-Bold="True" ForeColor="Blue" Text="Penality P/U"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                        ...
                                        <div class="row align-items-center mt-1" style="background-color: #4686F0">
                                            <div class="col">
                                                <div class="row align-items-center">
                                                    <div class="col text-center">
                                                        <asp:Label ID="Label73" runat="server" Font-Bold="True" ForeColor="White" Text="Other Charges"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-6 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label465" runat="server" ForeColor="Blue" Font-Bold="True" Text="Trans. Penality"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                                        <asp:TextBox class="form-control" ID="TextBox175" runat="server" Font-Names="Times New Roman">0.00</asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-6 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label389" runat="server" Font-Bold="True" Font-Italic="True" ForeColor="Blue" Text="Remarks For Penality:-"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                                        <asp:TextBox class="form-control" ID="TextBox144" runat="server" Font-Names="Times New Roman"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6 text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-4">
                                                        <asp:Label ID="Label390" runat="server" Font-Bold="True" ForeColor="Blue" Text="Remarks For Modification:-"></asp:Label>
                                                    </div>
                                                    <div class="col-8">
                                                        <asp:TextBox class="form-control" ID="TextBox145" runat="server" Font-Names="Times New Roman"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col text-start">
                                                <div class="row align-items-center">
                                                    <div class="col-2">
                                                        <asp:Label ID="Label76" runat="server" ForeColor="Blue" Font-Bold="True" Text="GARN Comments:-"></asp:Label>
                                                    </div>
                                                    <div class="col-10">
                                        ...
                                        <asp:Label ID="Label77" runat="server" Font-Bold="True" ForeColor="Red" Visible="False"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center justify-content-center" style="border-bottom: 3px; border-left: 3px; border-right: 3px; border-style: Groove; border-color: #FF3399;">
                                    <div class="col text-center">
                                        <div class="row align-items-center" style="background-color: #4686F0">
                                            <div class="col text-center">
                                                <asp:Label ID="Label79" runat="server" Font-Bold="True" ForeColor="White" Text="Material Details"></asp:Label>
                                            </div>
                                        </div>
                    ...
                    <asp:View ID="View2" runat="server">
                        <div class="row justify-content-center">
                            <div class="col-11 text-center">
                                <asp:Panel ID="Panel2" runat="server" BackColor="Transparent" BorderColor="#FF3300" BorderStyle="Dotted" Font-Names="Times New Roman" Style="text-align: left">
                                    <div class="row ms-1">
                                        <%--=================Left Panel ================================--%>
                                        <div class="col-5 text-start">
                                            ...
                                            <div class="row align-items-center mt-1">
                                                ...
                                                <div class="col-8">
                                                    <asp:TextBox class="form-control" ID="imp_garn_no_TextBox1" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-4 text-start">
                                                    <asp:Label ID="Label527" runat="server" ForeColor="Blue" Text="MAT SLNo"></asp:Label>
                                                </div>
                                                <div class="col-8">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-4 text-start">
                                                    <asp:Label ID="Label531" runat="server" ForeColor="Blue" Text="WO Sl No"></asp:Label>
                                                </div>
                                                <div class="col-8">
                                                ...
                                                <div class="col text-start me-1">
                                                    ...
                                                    <asp:Panel ID="Panel4" runat="server" CssClass="w-100">
                                                        <asp:FormView ID="imp_FormView1" runat="server" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" Font-Names="Times New Roman" ForeColor="Black" GridLines="Both" Height="240px" Width="100%">
                                                            ...
                                                            <ItemTemplate>
                                                                <h3 style="font-family: 'Times New Roman', Times, serif; font-size: large; color: #0000FF; margin-top: 0px;"><%# Eval("ITEM_NAME")%> </h3>
                                                                <br />
