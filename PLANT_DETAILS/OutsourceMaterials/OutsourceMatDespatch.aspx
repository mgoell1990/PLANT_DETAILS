<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" CodeBehind="OutsourceMatDespatch.aspx.vb" Inherits="PLANT_DETAILS.OutsourceMatDespatch" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row text-white mt-0" style="background: #296DA9">
        <div class="col text-center">
            <asp:Label ID="Label1" runat="server" Text="Invoicing of Outsourced Finished Goods" Font-Bold="True" Font-Size="Larger"></asp:Label>
        </div>
    </div>
                            ...
                            <div class="col-7 justify-content-center" style="border-style: Groove; border-color: #FFFF66">
                                ...
                                <div class="row justify-content-center align-items-center mt-2">
                                    ...
                                    <div class="col-6 text-start">
                                        <asp:TextBox class="form-control" ID="DropDownList26" runat="server" Font-Names="Times New Roman"></asp:TextBox>
                                    </div>
                                </div>
                            ...
                            <div class="col" style="border: 3px; border-style: Double; border-color: #00CC00">
                                    ...
                                    <div class="col ms-1 text-start">
                                        <div class="row align-items-center mt-1">
                                            <div class="col-1 g-0 text-start">
                                                <asp:Label ID="Label30" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="IRN No"></asp:Label>
                                            </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-1 g-0 text-start">
                                                <asp:Label ID="Label299" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Invoice No"></asp:Label>
                                            </div>
                                            <div class="col-2">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-2 text-start g-0">
                                                <asp:Label ID="Label405" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Buyer Name"></asp:Label>
                                            </div>
                                            <div class="col-1 text-start g-0">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-2 text-start g-0">
                                                <asp:Label ID="Label51" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Consignee Name"></asp:Label>
                                            </div>
                                            <div class="col-1 text-start g-0">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-1 g-0 text-start">
                                                <asp:Label ID="Label287" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Transporter"></asp:Label>
                                            </div>
                                            <div class="col-2 text-start">
                                            ...
                                            <div class="col-2 text-start g-0">
                                                <asp:Label ID="Label296" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Transp. Name"></asp:Label>
                                            </div>
                                            <div class="col-1 text-start g-0">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-1 g-0 text-start">
                                                <asp:Label ID="Label463" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="WO Sl No"></asp:Label>
                                            </div>
                                            <div class="col-2 text-start">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-1 g-0 text-start">
                                                <asp:Label ID="Label288" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Truck No"></asp:Label>
                                            </div>
                                            <div class="col-2 text-start">
                                                <asp:TextBox class="form-control" ID="TextBox55" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="col-2 text-start g-0">
                                                <asp:Label ID="Label309" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="RR No"></asp:Label>
                                            </div>
                                            <div class="col-2 text-start g-0">
                                                <asp:TextBox class="form-control" ID="TextBox69" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="col-1 text-start">
                                                <asp:Label ID="Label28" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="RR Date"></asp:Label>
                                            </div>
                                            <div class="col-2 text-start g-0">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-1 g-0 text-start">
                                                <asp:Label ID="Label293" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Form to Receive"></asp:Label>
                                            </div>
                                            <div class="col-2 text-start">
                                                <asp:DropDownList class="form-select" ID="DropDownList7" runat="server" Font-Names="Times New Roman">
                                            ...
                                            <div class="col-2 text-start g-0">
                                                <asp:Label ID="Label32" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Rcd Voucher No"></asp:Label>
                                            </div>
                                            <div class="col-2 text-start g-0">
                                            ...
                                            <div class="col-1 text-start">
                                                <asp:Label ID="Label33" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Balance"></asp:Label>
                                            </div>
                                            <div class="col-1 text-start g-0">
                                            ...
                                            <div class="col-1 text-start">
                                                <asp:Label ID="Label468" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Date"></asp:Label>
                                            </div>
                                            <div class="col-1 g-0 text-start">
                                ...
                                <div class="row">
                                    <div class="col-6 ms-1 text-start">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-2 g-0 text-start">
                                                <asp:Label ID="Label290" runat="server" Font-Bold="True" ForeColor="Blue" Text="Total Pcs/Bags"></asp:Label>
                                            </div>
                                            <div class="col-4 text-start">
                                        ...
                                        <div class="row align-items-center mt-2">
                                            ...
                                            <div class="col-6 text-start">
                                                ...
                                                <asp:Button ID="Button1" runat="server" Text="New" CssClass="btn btn-primary fw-bold" />
