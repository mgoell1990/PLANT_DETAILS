    ...
    Protected Sub Button45_Click(sender As Object, e As EventArgs) Handles Button45.Click
        ...
        Using conn_trans
            ...
            Try
                ...
                'conn.Open()
                ''Dim mc1 As New SqlCommand
                'mc1.CommandText = "select * from MAT_DETAILS where ISSUE_NO like 'si%' and LINE_NO='0' and (POST_TYPE<>'CANCEL' OR POST_TYPE='AUTH' OR POST_TYPE IS NULL) and RQD_BY='" & Session("userName") & "' and MAT_CODE='" & DropDownList3.Text.Substring(0, DropDownList3.Text.IndexOf(",") - 1) & "'"
                'mc1.Connection = conn
                ...
                Else
                    ISSUE_ERR_LABEL.Visible = True
                    ISSUE_ERR_LABEL.Text = "There is a pending requisition for the same material, Please get it clear first."
                End If
