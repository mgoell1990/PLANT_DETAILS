    ...
    Protected Sub Button45_Click(sender As Object, e As EventArgs) Handles Button45.Click
        ...
        Using conn_trans
            ...
            Try
                ...
                Dim MAT_PRICE, TOTAL_PRICE As Decimal
                MAT_PRICE = 0.0
                TOTAL_PRICE = 0.0
                ...
                ''INSERT MAT_DETAILS
                'conn.Open()
                Dim Query As String = "Insert Into MAT_DETAILS(AVG_PRICE,ISSUE_NO,ISSUE_TYPE,LINE_NO,LINE_DATE,FISCAL_YEAR,LINE_TYPE,MAT_CODE,MAT_QTY,RQD_QTY,ISSUE_QTY,MAT_BALANCE,UNIT_PRICE,TOTAL_PRICE,DEPT_CODE,PURPOSE,COST_CODE,ISSUE_BY,AUTH_BY,POST_TYPE,REMARKS,RQD_DATE,QTR,RQD_BY) VALUES (@AVG_PRICE,@ISSUE_NO,@ISSUE_TYPE,@LINE_NO,@LINE_DATE,@FISCAL_YEAR,@LINE_TYPE,@MAT_CODE,@MAT_QTY,@RQD_QTY,@ISSUE_QTY,@MAT_BALANCE,@UNIT_PRICE,@TOTAL_PRICE,@DEPT_CODE,@PURPOSE,@COST_CODE,@ISSUE_BY,@AUTH_BY,@POST_TYPE,@REMARKS,@RQD_DATE,@QTR,@RQD_BY)"
