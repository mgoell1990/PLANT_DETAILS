Public Class EinvoiceModelClassEY

    Public Property req As New EinvReqDetailsEY()
...
Public Class EinvReqDetailsEY
    ...
    Public Property lineItems As List(Of ItemDetailsEY)
