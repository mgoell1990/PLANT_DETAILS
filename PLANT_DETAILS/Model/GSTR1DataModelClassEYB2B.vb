Public Class GSTR1DataModelClassEYB2B

    Public Property req As List(Of GSTR1DataReqDetailsEYB2B)

End Class


Public Class GSTR1DataReqDetailsEYB2B
    ...
    Public Property lineItems As List(Of GSTR1DataItemDetailsEYB2B)

End Class


Public Class GSTR1DataItemDetailsEYB2B
