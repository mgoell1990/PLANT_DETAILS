Public Class B2CInvoiceWithDynamicQRCode
    Public Property req As New B2CInvoiceWithDynamicQRCodeDetailsEY()
End Class



Public Class B2CInvoiceWithDynamicQRCodeDetailsEY
    ...
    Public Property lineItems As List(Of B2CInvoiceWithDynamicQRCodeItemDetailsEY)
...
Public Class B2CInvoiceWithDynamicQRCodeItemDetailsEY
