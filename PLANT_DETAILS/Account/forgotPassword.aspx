<%@ Page Title="Log in" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="forgotPassword.aspx.vb" Inherits="PLANT_DETAILS.forgotPassword" Async="true" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <ol>
        <li>
            ...
            <br />
            <br />
            <asp:Button ID="Button66" runat="server" Text="Check" CssClass="bottomstyle"></asp:Button>
        </li>
        <asp:MultiView ID="MultiView2" runat="server">
            ...
            <asp:View ID="View1" runat="server">
                ...
                <br />
                <li>
                    <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="bottomstyle"></asp:Button>
            ...
            <asp:View ID="View2" runat="server">
                ...
                <li>
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Confirm Password" Width="175px"></asp:Label>
                    <asp:TextBox runat="server" ID="txtConfirmPassword" TextMode="Password" Width="120px" />
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtConfirmPassword" CssClass="field-validation-error" ErrorMessage="The password field is required." />

                </li>
                <br /><br />
                <li>
                    <asp:Button ID="Button2" runat="server" Text="Change Password" CssClass="bottomstyle"></asp:Button>
                </li>
