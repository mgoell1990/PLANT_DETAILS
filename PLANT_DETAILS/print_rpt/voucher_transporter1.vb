...
Public Class voucher_transporter1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "voucher_transporter1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.voucher_transporter1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedvoucher_transporter1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As voucher_transporter1 = New voucher_transporter1()
        rpt.Site = Me.Site
        Return rpt
    End Function
