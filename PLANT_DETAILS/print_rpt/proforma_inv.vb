...
Public Class proforma_inv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.proforma_inv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedproforma_inv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As proforma_inv = New proforma_inv()
        rpt.Site = Me.Site
        Return rpt
    End Function
