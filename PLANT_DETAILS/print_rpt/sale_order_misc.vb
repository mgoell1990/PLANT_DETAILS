...
Public Class sale_order_misc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.sale_order_misc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsale_order_misc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As sale_order_misc = New sale_order_misc()
        rpt.Site = Me.Site
        Return rpt
    End Function
