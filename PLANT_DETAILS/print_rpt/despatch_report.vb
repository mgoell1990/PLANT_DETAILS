...
Public Class despatch_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.despatch_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheddespatch_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As despatch_report = New despatch_report()
        rpt.Site = Me.Site
        Return rpt
    End Function
