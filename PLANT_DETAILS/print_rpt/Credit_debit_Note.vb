...
Public Class Credit_debit_Note
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.Credit_debit_Note.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCredit_debit_Note
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Credit_debit_Note = New Credit_debit_Note()
        rpt.Site = Me.Site
        Return rpt
    End Function
