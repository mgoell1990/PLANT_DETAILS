...
Public Class shedule_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.shedule_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedshedule_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As shedule_report = New shedule_report()
        rpt.Site = Me.Site
        Return rpt
    End Function
