...
Public Class gst_invoice_ti_new
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.gst_invoice_ti_new.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgst_invoice_ti_new
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As gst_invoice_ti_new = New gst_invoice_ti_new()
        rpt.Site = Me.Site
        Return rpt
    End Function
