...
Public Class view_ledger_entry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.view_ledger_entry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedview_ledger_entry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As view_ledger_entry = New view_ledger_entry()
        rpt.Site = Me.Site
        Return rpt
    End Function
