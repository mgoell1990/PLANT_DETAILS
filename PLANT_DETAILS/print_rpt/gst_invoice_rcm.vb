...
Public Class gst_invoice_rcm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.gst_invoice_rcm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgst_invoice_rcm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As gst_invoice_rcm = New gst_invoice_rcm()
        rpt.Site = Me.Site
        Return rpt
    End Function
