...
Public Class trans_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.trans_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtrans_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As trans_report = New trans_report()
        rpt.Site = Me.Site
        Return rpt
    End Function
