...
Public Class bill_forwarding
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.bill_forwarding.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedbill_forwarding
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As bill_forwarding = New bill_forwarding()
        rpt.Site = Me.Site
        Return rpt
    End Function
