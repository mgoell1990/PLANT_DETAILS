...
Public Class total_issue_store
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.total_issue_store.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtotal_issue_store
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As total_issue_store = New total_issue_store()
        rpt.Site = Me.Site
        Return rpt
    End Function
