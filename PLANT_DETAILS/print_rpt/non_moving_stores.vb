...
Public Class non_moving_stores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.non_moving_stores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednon_moving_stores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As non_moving_stores = New non_moving_stores()
        rpt.Site = Me.Site
        Return rpt
    End Function
