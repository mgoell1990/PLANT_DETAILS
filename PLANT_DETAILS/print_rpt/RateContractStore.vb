...
Public Class RateContractStore
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.RateContractStore.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRateContractStore
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RateContractStore = New RateContractStore()
        rpt.Site = Me.Site
        Return rpt
    End Function
