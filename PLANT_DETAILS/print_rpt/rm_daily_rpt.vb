...
Public Class rm_daily_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.rm_daily_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrm_daily_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rm_daily_rpt = New rm_daily_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
