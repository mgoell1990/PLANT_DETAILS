...
Public Class Sample_invoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.Sample_invoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSample_invoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sample_invoice = New Sample_invoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
