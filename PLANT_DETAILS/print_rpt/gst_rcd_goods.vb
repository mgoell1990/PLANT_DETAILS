...
Public Class gst_rcd_goods
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PLANT_DETAILS.gst_rcd_goods.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgst_rcd_goods
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As gst_rcd_goods = New gst_rcd_goods()
        rpt.Site = Me.Site
        Return rpt
    End Function
