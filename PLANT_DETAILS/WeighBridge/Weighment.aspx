<%@ Page Title="" Language="vb" AutoEventWireup="false" MaintainScrollPositionOnPostback ="true"    MasterPageFile="~/Site.Master" CodeBehind="Weighment.aspx.vb" Inherits="PLANT_DETAILS.Weighment" %>
   ...
   <script src="Scripts/jquery-ui.min.js" type="text/javascript"></script>
    ...
    <center>
       <div runat ="server" style ="min-height :600px;">
           ...
           <br />
           <asp:Panel ID="Panel16" runat="server" BorderColor="#FFFF66" BorderStyle="Groove" style="text-align: left" Width="396px" CssClass="brds">
               <asp:Label ID="search_Label" runat="server" BackColor="#4686F0" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" style="text-align: center; height:30px; line-height :30px; " Width="100%" CssClass="brds">Weigh Bridge</asp:Label>
             <br />
               <br />
             ...
             <br />
               <asp:Label ID="Label23" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="Fiscal Year" Width="80px"></asp:Label>
               <asp:DropDownList ID="DropDownList1" runat="server" BackColor="#00FFCC" Height="25px" Width="197px" AutoPostBack="True">
               </asp:DropDownList>
             <br />
               <asp:Label ID="Label460" runat="server" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Blue" Text="CRR No" Width="80px"></asp:Label>
             ...
             <br />
              <p style="text-align: center">
               ...
               <asp:Button ID="view_button" runat="server" Font-Bold="True"  Text="PRINT" Width="82px" CssClass="bottomstyle" />
             </p>
                  <br />
               <br />
           ...
           <br />
              <asp:Panel ID="Panel1" runat="server" BorderColor="Blue" BorderStyle="Groove" Font-Names="Times New Roman" HorizontalAlign="Center" style="text-align: left" Width="1000px" CssClass="brds" Visible="False">
         ...
         <br />
             ...
             <asp:Label ID="ERRLabel" runat="server" ForeColor="Red" Text="Label" Visible="False" Font-Bold="True"></asp:Label>
                  ...
                  <asp:DropDownList ID="pono_DropDownList" runat="server" AutoPostBack="True" Font-Names="Times New Roman" Width="142px">
                  </asp:DropDownList>
                  <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Supplier:-" Width="110px"></asp:Label>
                  <asp:TextBox ID="suplnameTextBox" runat="server" BackColor="#4686F0" Enabled="False" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" ReadOnly="True" Width="370px"></asp:TextBox>
                  <br />
                  <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Transporter:-" Width="120px"></asp:Label>
                  <asp:DropDownList ID="trans_DropDownList" runat="server" AutoPostBack="True" Font-Names="Times New Roman" Width="142px">
                  </asp:DropDownList>
                  <asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Trans Name:-" Width="110px"></asp:Label>
                  <asp:TextBox ID="transnameTextBox" runat="server" BackColor="#4686F0" Enabled="False" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" ReadOnly="True" Width="370px"></asp:TextBox>
                  <br />
                  <asp:Label ID="Label463" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="WO SL No" Width="120px"></asp:Label>
                  <asp:DropDownList ID="DropDownList21" runat="server" AutoPostBack="True" Font-Names="Times New Roman" Width="142px">
                  </asp:DropDownList>
                  <asp:Label ID="Label464" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Work Name" Width="110px"></asp:Label>
                  <asp:TextBox ID="TextBox174" runat="server" BackColor="#4686F0" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" ReadOnly="True" Width="370px"></asp:TextBox>
                  <br />
                  <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Truck No.:-" Width="120px"></asp:Label>
                  <asp:TextBox ID="lr_rr_noTextBox" runat="server" Font-Names="Times New Roman" Width="140px"></asp:TextBox>
                  <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Ship Name:-" Width="110px"></asp:Label>
                  <asp:TextBox ID="shipnameTextBox" runat="server" BackColor="#4686F0" Enabled="False" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Width="370px"></asp:TextBox>
                  <br />
                  <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Mat SLNo:-" Width="120px"></asp:Label>
                  <asp:DropDownList ID="mat_sl_noDropDownList" runat="server" AutoPostBack="True" Font-Names="Times New Roman" Width="142px">
                  </asp:DropDownList>
                  <asp:Label ID="Label13" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Mat Name:-" Width="110px"></asp:Label>
                  <asp:TextBox ID="matnameTextBox" runat="server" BackColor="#4686F0" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" ReadOnly="True" style="text-align: justify" Width="370px"></asp:TextBox>
                  <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="A/U:-" Width="40px"></asp:Label>
                  <asp:TextBox ID="au_TextBox" runat="server" BackColor="#4686F0" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" ReadOnly="True" Width="80px"></asp:TextBox>
                  <br />
                 ...
                 $(function () {
                  ...
                  <asp:TextBox ID="be_TextBox" runat="server" Font-Names="Times New Roman" ForeColor="Black" Width="140px">N/A</asp:TextBox>
                  <asp:Label ID="Label14" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="BE Date:-" Width="110px"></asp:Label>
                  <asp:TextBox ID="bedate_TextBox" runat="server" BackColor="#4686F0" Enabled="False" Font-Names="Times New Roman" ForeColor="White" Width="120px">N/A</asp:TextBox>
                  <br />
                  <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="BL No:-" Width="120px"></asp:Label>
                  <asp:TextBox ID="bl_noTextBox" runat="server" BackColor="#4686F0" Enabled="False" Font-Names="Times New Roman" ForeColor="White" Width="139px">N/A</asp:TextBox>
                  <asp:Label ID="Label15" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="BL Date:-" Width="110px"></asp:Label>
                  <asp:TextBox ID="bldate_TextBox" runat="server" BackColor="#4686F0" Enabled="False" Font-Names="Times New Roman" ForeColor="White" Width="120px">N/A</asp:TextBox>
                  <br />
                  <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Chalan No:-" Width="120px"></asp:Label>
                  <asp:TextBox ID="chalan_TextBox" runat="server" Font-Names="Times New Roman" Width="139px"></asp:TextBox>
                  <asp:Label ID="Label16" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Chalan Dt.:-" Width="112px"></asp:Label>
                  <asp:TextBox ID="chalandate_TextBox" runat="server" Font-Names="Times New Roman" Width="120px"></asp:TextBox>
            ...
            <br />
             ...
             <asp:Label ID="Label17" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Rcvd Qty:-" Width="112px"></asp:Label>
            ...
            <div runat ="server" style ="float :right ;">
                 <asp:Button ID="crr_add_Button" runat="server"  Text="ADD" CssClass="bottomstyle" Font-Size="Small" Width="85px" />
                  ...
                  <br />
                   <asp:Label ID="Label466" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Total Mt:-" Width="120px"></asp:Label>
                  <asp:TextBox ID="Actual_Material_Weight" runat="server" Font-Names="Times New Roman" Width="100px">0</asp:TextBox>
                  <asp:Panel ID="Panel11" runat="server" ScrollBars="Auto" Width="993px">
                  ...
                  <div runat="server" style =" float :right;">
                      <asp:Button ID="Button1" runat="server" Text="CLOSE" CssClass="bottomstyle" Font-Size="Small"></asp:Button>
                       <asp:Button ID="crr_cancel_Button" runat="server" Font-Bold="True"  Text="CANCEL" Width="85px" CssClass="bottomstyle" Font-Size="Small" />
                        <asp:Button ID="crr_save_Button" runat="server" Font-Bold="True" Text="SAVE" Width="85px" CssClass="bottomstyle" Font-Size="Small" UseSubmitBehavior="false" OnClientClick="this.disabled='true'; this.value='Please Wait...'"/>
                  </div>
                 <br />
                  <br />
                  <br />
