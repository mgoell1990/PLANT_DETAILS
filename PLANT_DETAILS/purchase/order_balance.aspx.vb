...
Public Class order_balance
    ...
    Protected Sub Button64_Click(sender As Object, e As EventArgs) Handles Button64.Click
        ...
        If (DropDownList50.SelectedValue = "Purchase Order") Then
            ...
            DECLARE @TT TABLE(PO_NO VARCHAR(60),W_SLNO VARCHAR(30),W_NAME VARCHAR(150),W_AU VARCHAR(30),W_START_DATE VARCHAR(30),W_END_DATE VARCHAR(30),W_QTY DECIMAL(16,3))
            INSERT INTO @TT
        ...
        ElseIf (DropDownList50.SelectedValue = "Work Order") Then
            ...
            DECLARE @TT TABLE(PO_NO VARCHAR(60),W_SLNO VARCHAR(30),W_NAME VARCHAR(500),W_AU VARCHAR(30),W_START_DATE VARCHAR(30),W_END_DATE VARCHAR(30),W_QTY DECIMAL(16,3))
            INSERT INTO @TT
