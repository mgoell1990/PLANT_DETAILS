<%@ Page Title="" Language="vb" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="CloseOrder.aspx.vb" Inherits="PLANT_DETAILS.CloseOrder" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row text-white mt-0" style="background: #296DA9">
        <div class="col text-center">
            <asp:Label ID="Label1" runat="server" Text="Close Order" Font-Bold="True" Font-Size="Larger"></asp:Label>
        </div>
    </div>
                    ...
                    <asp:View ID="View1" runat="server">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-5 text-center" style="border-color: Blue; border-style: Groove">
                                ...
                                <div class="row align-items-center mt-1 mb-1">
                                    <div class="col-5 text-end">
                                        <asp:Label ID="Label3" runat="server" ForeColor="Blue" Text="Action"></asp:Label>
                                    </div>
                                    <div class="col text-start">
                                ...
                                <div class="row align-items-center mt-1 mb-1">
                                    ...
                                    <div class="col text-start">
                                        <asp:Button ID="Button64" runat="server" Text="Proceed" CssClass="btn btn-primary" />
                                ...
                                <div class="row align-items-center mt-1 mb-1">
                                    ...
                                    <div class="col text-center">
                                        <asp:Label ID="lblErrorText" runat="server" Text="Label" Visible="False"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
