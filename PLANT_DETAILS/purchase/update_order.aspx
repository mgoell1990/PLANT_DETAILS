<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback ="true"  CodeBehind="update_order.aspx.vb" Inherits="PLANT_DETAILS.update_order" %>
   ...
   <script src="Scripts/jquery-ui.min.js" type="text/javascript"></script>
    ...
    <center>
          <div runat ="server" style ="min-height :600px; font-family: 'Times New Roman', Times, serif; line-height :20px;"  >
              <asp:Panel ID="Panel700" runat="server" BorderColor="Red"  BorderStyle="Groove" Font-Names="Times New Roman" style="text-align: left" Width="550px" CssClass="brds">
        <asp:Label ID="Label343" runat="server" BackColor="Blue" Font-Bold="True" Font-Size="Large" ForeColor="White" style="text-align: center" Text="ORDER SUBMIT" Width="100%" CssClass="brds"></asp:Label>
        <br />
                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%">
                      <Columns>
                           <asp:TemplateField HeaderText="Order No">
                           <ItemTemplate>
                           <asp:linkButton ID="Button1" ForeColor ="BLUE" runat="server" Text='<%#Eval("SO_NO")%>' Commandname ='<%#Eval("SO_NO")%>' OnClick ="prv"    />
                           </ItemTemplate> 
                           <ItemStyle ForeColor="Blue" Width="100px" />
                           </asp:TemplateField>
                           <asp:BoundField DataField="SO_ACTUAL" HeaderText="Actual Order No" />
                           <asp:BoundField HeaderText="Order Date" DataField="SO_ACTUAL_DATE" />
                           <asp:BoundField HeaderText="Party Name" DataField="SUPL_NAME" />
                      </Columns>
                  </asp:GridView>
  ...
  <asp:Label ID="Label350" runat="server" Font-Bold="True" Font-Overline="False" ForeColor="Red" Text="&lt;marquee&gt;Please do not Use &quot; ' &quot; (single quotation mark) in any field &lt;/marquee&gt;" Font-Size="Large"></asp:Label>
              ...
              <br />
                  ...
                  <asp:Panel ID="Panel15" runat="server">
                      ...
                      <asp:Label ID="Label271" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" style="text-align: left" Text="S. Tax On Freight:-" Width="151px"></asp:Label>
              ...
              <br />
                  <asp:Panel ID="Panel2" runat="server" Height="51px" style="text-align: center">
                       <asp:Button ID="Button2" runat="server" CssClass="bottomstyle" Font-Bold="True" Font-Size="Medium" TabIndex="69" Text="VIEW MATERIAL" Width="150px" />
                     <asp:Button ID="Button1" runat="server" CssClass="bottomstyle" Font-Bold="True" Font-Size="Medium" TabIndex="69" Text="SUBMIT" Width="150px" />
                      <asp:Button ID="Button33" runat="server" CssClass="bottomstyle" Font-Bold="True" Font-Size="Medium" TabIndex="69" Text="SAVE" Width="150px" UseSubmitBehavior="false" OnClientClick="this.disabled='true'; this.value='Please Wait...'"/>
