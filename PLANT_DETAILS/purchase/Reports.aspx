<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Reports.aspx.vb" Inherits="PLANT_DETAILS.Reports" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row text-white mt-0" style="background: #296DA9">
        <div class="col text-center">
            <asp:Label ID="Label1" runat="server" Text="Purchase Report Section" Font-Bold="True" Font-Size="Larger"></asp:Label>
        </div>
    </div>
                                        ...
                                        <asp:Panel ID="Panel16" runat="server" ScrollBars="Auto">
                                            <asp:GridView ID="GridView10" Style="font-size: 15px" CssClass="table table-bordered border-2 table-responsive text-center" runat="server" AutoGenerateColumns="False" CellPadding="4" ShowHeaderWhenEmpty="True">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="SO_NO" HeaderText="System Order No." />
                                                    <asp:BoundField DataField="SO_ACTUAL" HeaderText="Order No." />
