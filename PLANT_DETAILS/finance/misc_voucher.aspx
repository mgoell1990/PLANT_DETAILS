...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row align-items-center mt-1">
        ...
        <div class="col-5 text-end">
            <asp:Label ID="Label7" runat="server" Text="Bill track ID"></asp:Label>
        </div>
        <div class="col-2 text-start">
            <asp:DropDownList class="form-select" ID="ddlBillTrackID" runat="server" AutoPostBack="True" TabIndex="5">
            </asp:DropDownList>
        </div>
