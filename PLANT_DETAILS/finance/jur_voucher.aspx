                            ...
                            <asp:MultiView ID="MultiView1" runat="server">
                                ...
                                <asp:View ID="View1" runat="server">
                                    ...
                                    <div class="row  align-items-center">
                                        <div class="col-2 text-start">
                                            <asp:Label ID="Label1" runat="server" ForeColor="Blue" Text="Reversal Date"></asp:Label>
                                        </div>
                                        <div class="col-2 text-start g-0">
                                        ...
                                        <div class="col-1 text-start">
                                            <asp:Label ID="Label11" runat="server" ForeColor="Blue" Text="Rev. Journal No."></asp:Label>
                                        </div>
                                        <div class="col-2 text-start">
                                            <asp:TextBox class="form-control" ID="TextBox66" runat="server" TabIndex="8"></asp:TextBox>
                                        </div>
                                        <div class="col-2 text-start">
                                            <asp:Label ID="Label10" runat="server" ForeColor="Blue" Text="Rev. Voucher No."></asp:Label>
                                        </div>
                                        <div class="col-2 text-start">
                                            <asp:TextBox class="form-control" ID="TextBox65" runat="server" BackColor="#4686F0" ForeColor="White"></asp:TextBox>
                                        </div>
                                    </div>
