<%@ Page Title="" Language="vb" AutoEventWireup="false" MaintainScrollPositionOnPostback ="true"  MasterPageFile="~/Site.Master" CodeBehind="rm_phy_adjustment.aspx.vb" Inherits="PLANT_DETAILS.rm_phy_adjustment" %>
    ...
    <center>
        <div runat ="server" style ="min-height :600px; font-family: 'Times New Roman', Times, serif; "  >
            <asp:Panel ID="Panel1" runat="server" BorderColor="#4686F0" BorderStyle="Double" Font-Names="Times New Roman" Font-Size="Small" Width="1000px" style="text-align: left" CssClass="brds">
                <asp:Label ID="Label270" runat="server" BackColor="Blue" Font-Bold="True" Font-Size="Large" ForeColor="White" Text="RAW MATERIAL PHYSICAL ADJUSTMENT" Width="100%" Height="20" style="text-align: center; padding-top:5px" CssClass="brds"></asp:Label>
              <br />
              ...
              <div style =" float :left; width :443px; height: 280px; " runat ="server" >
                  ...
                  <asp:TextBox ID="Adj_no_TextBox" runat="server" BackColor="Red" Font-Names="Times New Roman" ForeColor="White" ReadOnly="True" Width="120px" Font-Bold="True"></asp:TextBox>
                  <br />
