<%@ Page Title="" Language="vb" AutoEventWireup="false" MaintainScrollPositionOnPostback ="true"  MasterPageFile="~/Site.Master" CodeBehind="r_auth.aspx.vb" Inherits="PLANT_DETAILS.r_auth" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--<script type="text/javascript">
                     ...
                     $("[id$=TextBox171]").autocomplete({
                          ...
                          $.ajax({
                   url: '<%=ResolveUrl("~/Service.asmx/R_ISSUE_AUTH")%>',
           ...
           select: function (e, i) {
               $("[id$=DropDownList3]").val(i.item.val);
                 ...
                 $("[id$=TextBox1]").val(i.item.RQD_BY);
                 $("[id$=TextBox3]").val(i.item.RQD_DATE);
             },
             minLength: 1
         });
     });
    ...
    <div class="row text-white" style="background: #296DA9">
        <div class="col text-center">
            <asp:Label ID="Label7" runat="server" Text="Raw Material Authorization" Font-Bold="True" Font-Size="Larger"></asp:Label>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-8" style="border-right: 5px groove #FF0066;">
                        ...
                        <div class="row align-items-center">
                            <div class="col-4 text-end">
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Blue" Text="Mat Code" ></asp:Label>
                        ...
                        <div class="row align-items-center">
                            <div class="col-4 text-end">
                                <asp:Label ID="Label5" runat="server" Font-Bold="True" ForeColor="Blue" Text="Reqd Qty" ></asp:Label>
                        ...
                        <div class="row align-items-center">
                            <div class="col-4 text-end">
                                <asp:Label ID="Label9" runat="server" Font-Bold="True" ForeColor="Blue" Text="Req. By" ></asp:Label>
                            </div>
                            <div class="col-8 text-start">
                        ...
                        <div class="row align-items-center">
                            <div class="col-4 text-end">
                                <asp:Label ID="Label10" runat="server" Font-Bold="True" ForeColor="Blue" Text="Req. Date" ></asp:Label>
                            </div>
                            <div class="col-8 text-start">
                                <asp:TextBox ID="TextBox3" runat="server" class="form-control"  BackColor="White"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center mb-2">
                            <div class="col-4 text-end">
                                <asp:Label ID="Label11" runat="server" Font-Bold="True" ForeColor="Blue" Text="Purpose"></asp:Label>
                            </div>
                            <div class="col-8 text-start">
                    ...
                    <div class="col-4">
                        ...
                        <div class="row mt-2 align-items-center">
                            <div class="col-5 text-end">
                                <asp:Label ID="Label12" runat="server" Font-Bold="True" ForeColor="Blue">Account Unit</asp:Label>
                            </div>
                            ...
                            <div class="col-5 text-end">
                                <asp:Label ID="Label13" runat="server" Font-Bold="True" ForeColor="Blue" Text="Availble Stock"></asp:Label>
                            </div>
                            <div class="col-7 text-start">
                            ...
                            <div class="col-5 text-end">
                                <asp:Label ID="Label14" runat="server" Font-Bold="True" ForeColor="Blue" Text="Unit Price"></asp:Label>
                            </div>
                            <div class="col-7 text-start">
                            ...
                            <div class="col-5 text-end">
                                <asp:Label ID="Label15" runat="server" Font-Bold="True" ForeColor="Blue" Text="Line No"></asp:Label>
                            </div>
                            <div class="col-7 text-start">
