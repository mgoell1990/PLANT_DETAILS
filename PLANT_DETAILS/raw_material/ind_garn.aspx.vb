...
Public Class ind_garn
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            DropDownList2.DataSource = ds.Tables("FISCAL_YEAR")
            DropDownList2.DataValueField = "FY"
    ...
    Protected Sub new_button_Click(sender As Object, e As EventArgs) Handles new_button.Click
        If type_DropDown.SelectedValue = "RAW MATERIAL" Then
    ...
    Protected Sub imp_crr_no_DropDownList1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles imp_crr_no_DropDownList1.SelectedIndexChanged
        ...
        Else
            ...
            conn.Open()
            da = New SqlDataAdapter("select PO_RCD_MAT.MAT_SLNO from po_rcd_mat join po_ord_mat on PO_RCD_MAT .po_no=PO_ORD_MAT .po_no and PO_RCD_MAT .mat_slno=PO_ORD_MAT .mat_slno and PO_ORD_MAT.amd_no=PO_RCD_MAT.amd_no JOIN MATERIAL ON MATERIAL.MAT_CODE =PO_RCD_MAT .MAT_CODE where PO_RCD_MAT .crr_no='" & imp_crr_no_DropDownList1.Text & "' and PO_RCD_MAT.GARN_NO = 'Pending'", conn)
            da.Fill(dt)
            conn.Close()
                    ...
                    If imp_GridView3.Rows(I).Cells(3).Text = imp_mat_slno_DropDownList2.SelectedValue Then
                        ...
                        Else
                            ...
                            If tole_weight <= TRANS_DIFF Then
                                ...
                                If CDec(imp_GridView3.Rows(I).Cells(12).Text.Trim) > 0 Then
        ...
        Using conn_trans
            ...
            Try
                ...
                For I = 0 To imp_GridView3.Rows.Count - 1
                    ...
                    conn.Open()
                    mc.CommandText = "select * from MATERIAL where MAT_CODE = '" & imp_GridView3.Rows(I).Cells(4).Text & "'"
                    mc.Connection = conn
                    dr = mc.ExecuteReader
                    If dr.HasRows Then
                        dr.Read()
                    ...
                    conn.Open()
                    MCc.CommandText = "select * from work_group where work_type = (SELECT PO_TYPE FROM ORDER_DETAILS WHERE SO_NO='" & po_no & "')"
                    MCc.Connection = conn
                    dr = MCc.ExecuteReader
                    If dr.HasRows Then
                        dr.Read()
    ...
    Protected Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        ElseIf TextBox175.Text = "" Or IsNumeric(TextBox175.Text) = False Then
            TextBox175.Focus()
            GARN_ERR_LABLE.Text = "Penalty For Transporter can't be empty or char "
        End If
        ...
        Using conn_trans
            ...
            Try
                ...
                For I = 0 To GridView2.Rows.Count - 1
                    ...
                    'Dim MC As New SqlCommand
                    conn.Open()
                    MC.CommandText = "select * from MATERIAL where MAT_CODE = '" & GridView2.Rows(I).Cells(4).Text & "'"
                    MC.Connection = conn
                    dr = MC.ExecuteReader
                    If dr.HasRows Then
                        dr.Read()
    ...
    Protected Sub DropDownList2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownList2.SelectedIndexChanged
        If (DropDownList2.SelectedValue <> "Select") Then
            ...
            da = New SqlDataAdapter("select distinct GARN_NO from PO_RCD_MAT where GARN_NO LIKE 'RGARN%' and garn_date between '" & 2000 + CInt(Left(DropDownList2.SelectedValue, 2)) & "-04-01' and '" & 2000 + CInt(Right(DropDownList2.SelectedValue, 2)) & "-03-31' ORDER BY GARN_NO", conn)
