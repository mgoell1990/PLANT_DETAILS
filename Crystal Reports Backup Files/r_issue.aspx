        ...
        <div runat ="server" style ="min-height :600px; font-family: 'Times New Roman', Times, serif;">
                ...
                <div id="fastdivision1" aria-orientation="vertical" aria-selected="undefined" style="width: 683px; height: 355px;">
                 ...
                 <br />
                     ...
                     $("[id$=TextBox171]").autocomplete({
                          ...
                          $.ajax({
                   url: '<%=ResolveUrl("~/Service.asmx/R_MAT_ISSUE")%>',
           ...
           select: function (e, i) {
             ...
             minLength: 1
                        ...
                        <asp:TextBox ID="TextBox163" runat="server" Font-Names="Times New Roman" Width="95px" BorderStyle="Solid" Enabled="False"></asp:TextBox>
                        <br />
&nbsp;
                        <asp:Label ID="Label451" runat="server" Font-Bold="True" ForeColor="Blue" Text="Issue Qty" Width="110px"></asp:Label>
                ...
                <br />
                        ...
                        <asp:TextBox ID="TextBox172" runat="server" BackColor="White" BorderStyle="Solid" Enabled="False" Width="95px"></asp:TextBox>
                 <br />
                        &nbsp;&nbsp;<asp:Label ID="Label24" runat="server" Font-Bold="True" ForeColor="Blue" Text="Cost Center" Width="110px"></asp:Label>
                        <asp:TextBox ID="TextBox173" runat="server" BackColor="White" BorderStyle="Solid" Enabled="False" Width="260px"></asp:TextBox>
                        ...
                        <div runat="server" style=" margin-left :120px;">
                            <asp:TextBox ID="TextBox2" runat="server" BorderStyle="None" Enabled="False" Font-Names="Times New Roman" Height="58px" TextMode="MultiLine" Width="260px"></asp:TextBox>
                        </div>
                        <br />
                        &nbsp;
                        <br />
