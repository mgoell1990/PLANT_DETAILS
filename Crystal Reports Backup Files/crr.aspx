   ...
   <script src="Scripts/jquery-ui.min.js" type="text/javascript"></script>
    ...
    <center>
       <div runat ="server" style ="min-height :600px;">
              <asp:Panel ID="Panel1" runat="server" BorderColor="Blue" BorderStyle="Groove" Font-Names="Times New Roman" HorizontalAlign="Center" style="text-align: left" Width="1000px" CssClass="brds" Font-Size="Medium">
         ...
         <br />
            ...
            <br />
             <asp:Label ID="Label463" runat="server" Font-Bold="True" ForeColor="Blue" Text="WO SL No" Width="120px" Font-Size="Small"></asp:Label>
             <asp:DropDownList ID="DropDownList21" runat="server" AutoPostBack="True" Width="142px" Font-Names="Times New Roman">
             </asp:DropDownList>
             <asp:Label ID="Label464" runat="server" Font-Bold="True" ForeColor="Blue" Text="Work Name" Width="110px" Font-Size="Small"></asp:Label>
            ...
            <br />
             ...
             <asp:Label ID="Label20" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Blue" Text="Bag Weight:-" Width="90px"></asp:Label>
