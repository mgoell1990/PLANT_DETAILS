     ...
     <center>
        <div runat ="server" style ="min-height :600px; font-family: 'Times New Roman', Times, serif;">
            <asp:Panel ID="Panel2" runat="server" BorderColor="Red" BorderStyle="Groove" BorderWidth="5px" Font-Names="Times New Roman" Font-Size="X-Small" Height="354px" style="text-align: left" Width="705px">
                <div id="fastdivision1" aria-orientation="vertical" aria-selected="undefined" style="width: 700px; height: 355px;">
                    <div style="border-right: 5px groove #FF0066; float: left; text-align: left; width: 450px; height: 347px; font-size: small;">
                        <asp:Label ID="Label435" runat="server" Font-Bold="True" Font-Size="X-Large" style="line-height :30px; text-align: center;" ForeColor="White" Height="30px" Text="AUTHORIZATION" Width="100%" BackColor="#4686F0"></asp:Label>
                 <br />
                      &nbsp;&nbsp;<br />
           ...
           select: function (e, i) {
             ...
             minLength: 1
                        ...
                        <asp:TextBox ID="DropDownList3" runat="server" Font-Names="Times New Roman" Width="260px" Enabled="False" BackColor="White" BorderStyle="Solid"></asp:TextBox>
                        <br />
                        &nbsp;&nbsp;<asp:Label ID="Label426" runat="server" Font-Bold="True" ForeColor="Blue" Text="Reqd Qty" Width="110px"></asp:Label>
                        <asp:TextBox ID="TextBox163" runat="server" Font-Names="Times New Roman" Width="95px" BorderStyle="Solid"></asp:TextBox>
                        <br />
                        &nbsp;&nbsp;<asp:Label ID="Label425" runat="server" Font-Bold="True" ForeColor="Blue" Text="Issue Type" Width="110px"></asp:Label>
                        <asp:TextBox ID="TextBox172" runat="server" Width="95px" Enabled="False" BackColor="White" BorderStyle="Solid"></asp:TextBox>
                        <br />
                        &nbsp;&nbsp;<asp:Label ID="Label24" runat="server" Font-Bold="True" ForeColor="Blue" Text="Cost Center" Width="110px"></asp:Label>
                        <asp:TextBox ID="TextBox173" runat="server" Width="260px" Enabled="False" BackColor="White" BorderStyle="Solid"></asp:TextBox>
                        ...
                        <div runat="server" style=" margin-left :120px;">
                            <asp:TextBox ID="TextBox2" runat="server" Font-Names="Times New Roman" Height="58px" TextMode="MultiLine" Width="260px" Enabled="False" BorderStyle="None"></asp:TextBox>
                        </div>
                        <br />
&nbsp;
                <br />
                ...
                <br />
                 ...
                 <br />
                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" ForeColor="Blue" Width="100%">
                            <asp:ListItem Selected="True">Authorized</asp:ListItem>
